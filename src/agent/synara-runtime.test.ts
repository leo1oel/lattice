...
describe("Synara runtime URLs", () => {
  ...
  it("maps encoded absolute Agent file links back into the active project", () => {
    const root = "/Users/example/Documents/research/Example Project";
    expect(synaraProjectRelativeFilePath(
      "/Users/example/Documents/research/Example%20Project/notes/vision-distillation.md",
      root,
  ...
  it("rejects Agent file links outside the active project", () => {
    const root = "/Users/example/Documents/research/Example Project";
    expect(synaraProjectRelativeFilePath("/Users/example/Documents/other.md", root)).toBeNull();
    ...
    expect(synaraProjectRelativeFilePath("/Users/example/Documents/research/Example Project 2/a.md", root))
      .toBeNull();
  });
