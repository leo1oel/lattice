...
export function OnboardingTour(props: {
  ...
  const steps = useMemo<Step[]>(() => {
    ...
    },
    {
      ...
      content: t`Agent can read your manuscript, notes, papers, and spreadsheets. Ask it to draft text, verify a claim against a source, analyze results, or revise files across the project`,
      buttons: READING_BUTTONS,
      placement: "right-start",
    },
    ];
