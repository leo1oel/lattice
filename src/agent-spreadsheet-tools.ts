...
import type { SpreadsheetBatchUpdateRequest } from "./spreadsheet-types";
import { SPREADSHEET_AGENT_ORIGIN, spreadsheetSnapshotFromDoc } from "./spreadsheet-yjs";
...
export type AgentSpreadsheetAction = "read" | "batch_update";
