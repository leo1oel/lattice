...
// Lattice integration: keep hover motion shared with the host menus.
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        data-slot="dropdown-menu-content" data-ok-vendor=""
        sideOffset={sideOffset}
        align={align}
        className={cn(
          'fluid-hover-surface',
          'z-50 max-h-(--radix-dropdown-menu-content-available-height) w-(--radix-dropdown-menu-trigger-width) min-w-32 origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 data-[state=closed]:overflow-hidden subtle-scrollbar',
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      data-slot="dropdown-menu-sub-content" data-ok-vendor=""
      className={cn(
        'fluid-hover-surface',
        'z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[96px] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1 ring-foreground/10 data-[state=closed]:overflow-hidden subtle-scrollbar',
        popupMotionClassName,
        className,
      )}
      {...props}
