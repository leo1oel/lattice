import { mediaKindForSidebarAssetExtension } from '@ok-core';
import { File, Film, FolderOpen, ImageIcon, Volume2 } from 'lucide-react';
import type { ComponentProps } from 'react';
import { getFileExtension } from '@ok-app/components/file-tree-rename-validation';
import { lucideIconToSvgString } from '@ok-app/editor/registry/lucide-svg';
