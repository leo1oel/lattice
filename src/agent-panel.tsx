...
function AgentConfigPicker(props: {
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent liquid side="top" align="start" sideOffset={7} collisionPadding={8} avoidCollisions className="agent-config-menu">
        <Popover open={modelsOpen} onOpenChange={(nextOpen) => { setModelsOpen(nextOpen); if (nextOpen) setEffortsOpen(false); }}>
          ...
          <PopoverContent liquid side="right" align="start" sideOffset={7} collisionPadding={8} avoidCollisions className="agent-config-options model-options" role="listbox" aria-label="Models">
        ...
        <Popover open={effortsOpen} onOpenChange={(nextOpen) => { setEffortsOpen(nextOpen); if (nextOpen) setModelsOpen(false); }}>
          ...
          <PopoverContent liquid side="right" align="start" sideOffset={7} collisionPadding={8} avoidCollisions className="agent-config-options effort-options" role="listbox" aria-label="Reasoning efforts">
            {efforts.map((effort) => (
