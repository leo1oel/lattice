...
// Both derive from their option list rather than aliasing the FIXED_* constant,
// so the "what the app falls back to" name stays correct if a second option is
// ever added ahead of the current one.
