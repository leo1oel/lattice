// Installed from https://www.fluidfunctionalism.com/r/use-fluid-hover.json.
...
const fade: Transition = { duration: spring.fast.duration };
...
/** The rect and session a set of props resolves to. */
