...
// Overflow stays for long lists; surfaces.css zeros the classic scrollbar
// gutter so fixed-width menus don't jump left when the 10px track appears.
export const menuViewportClassName =
  "overflow-x-hidden overflow-y-auto p-[var(--surface-inset)] [scrollbar-width:none]";
