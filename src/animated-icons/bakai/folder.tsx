...
/* The open pose (FolderOpen's slab), the overshoot and the bounce are keyframe-only
   values, so they live with the keyframes in src/animated-icons/bakai-icons.css — that
   stylesheet, not this module, is what the app loads. */
