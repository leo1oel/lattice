 ...
 * `import("./pdf-viewer")` at a call site, or that site gets its own copy of
 * the module graph in a second chunk.
 */
let visualMarkdownEditorWarmed = false;

export const loadPdfPreviewModule = () => import("./pdf-viewer");

export const loadVisualMarkdownEditorModule = () => import("./visual-markdown-editor")
  .then((module) => {
...
export const loadBoardEditorModule = () => import("./board-editor");

export const loadSpreadsheetEditorModule = () => import("./spreadsheet-editor");
