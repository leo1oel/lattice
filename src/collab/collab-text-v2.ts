 ...
 * off string matching.
 */
class ClientDestroyedErrorV2 extends Error { constructor() { super("Client is destroyed"); } }
...
/** An opaque, independently releasable lease that keeps one pooled document alive. */
