...
type ImportResumeV2 = { projectInstanceId: string; credentialRef: string; manifestHash: string; operationId: string; fileIds: Record<string, string>; completed: string[]; error: string };
