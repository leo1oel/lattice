...
const drawings = {
  ...
  7: `<defs><radialGradient id="bracket-upper" cx="0" cy="0" r="1"><stop offset="0" stop-color="#c4c4c4"/><stop offset=".35" stop-color="#c4c4c4" stop-opacity=".85"/><stop offset="1" stop-color="#c4c4c4" stop-opacity="0"/></radialGradient><radialGradient id="bracket-lower" href="#bracket-upper" cx="1" cy="1" fx="1" fy="1"/></defs><path stroke="url(#bracket-upper)" stroke-linejoin="miter" d="M42 178V54H290"/><path stroke="url(#bracket-lower)" stroke-linejoin="miter" d="M1150 666H1398V542"/>`,
