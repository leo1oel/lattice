...
| `.github/` | 10 | Workflows (`ci.yml`, `release.yml`, `release-cache.yml`) plus the open-source contribution scaffolding: `CODEOWNERS`, `SECURITY.md`, `dependabot.yml`, the PR template and three issue templates. |
